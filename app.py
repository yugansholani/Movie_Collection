...
def list_movie(lists):
    ...
    print(f"{title} have {hero} & {heroine} as lead actors.")
...
def find_movie():
    ...
    if search == 'movie':
        ...
        for films in movies:
            ...
            print("MOVIE TITLE YOU ARE SEARCHING IS NOT FOUND! Try Again Later...")
        ...
        for actor in movies:
            if hero == actor['hero']:
                ...
                continue
        if a == 0:
            print("ACTOR YOU ARE SEARCHING IS NOT FOUND! Try Again Later...")
